...
const MobileBottomNavBar = () => {
  return (
    <section>
      <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 bg-white  border-t border-gray-200 rounded-t-lg shadow-lg  w-full  lg:hidden z-10 ">
        <div className="flex justify-between mx-3 items-center py-2">
          <Link
